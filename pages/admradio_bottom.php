		...
		<div class="contact_top_menu">
			...
			if ($_GET['action'] == "update") {
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="portbase" type="text"<?php if ($_GET['action'] == "update") { echo ' disabled="disabled"'; }?> value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_portbase; } else { echo $nextport; }?>" />
					<span class="field_desc"><?php echo $messages["107"];?></span>
				</div>
				<div class="input_field">
					<label for="a"><?php echo $messages["108"];?></label>
					<input class="mediumfield" name="maxuser" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_maxuser; } else { echo "32"; }?>" />
					<span class="field_desc"><?php echo $messages["109"];?></span>
				</div>
				<div class="input_field">
					<label for="a"><?php echo $messages["110"];?></label>
					<input class="mediumfield" name="bitrate" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_bitrate; } else { echo "128000"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="webspace" type="text" value="<?php if ($_GET['action'] == "update") { echo ($updateget_var_t_webspace/1024); } else { echo "20"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" readonly="readonly" name="logfile" type="text" value="<?php if ($_GET['action'] == "update") {
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="showlastsongs" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_showlastsongs; } else { echo "10"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="w3clog" type="text" readonly="readonly" value="<?php if ($_GET['action'] == "update") {
				...
				<div class="input_field">
               	...
               	<div class="input_field">
					...
					<input class="mediumfield" name="yport" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_yport; } else { echo "80"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="relayport" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_relayport; } else { echo "0"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="autodumpusers" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_autodumpusers; } else { echo "0"; }?>" />
					<span class="field_desc"><?php echo $messages["151"];?></span>
				</div>  
				<div class="input_field">
					<label for="a"><?php echo $messages["152"];?></label>
					<input class="mediumfield" name="autodumpsourcetime" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_autodumpsourcetime; } else { echo "30"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="publicserver" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_publicserver; } else { echo "default"; }?>" />
				...
				<div class="input_field">
					...
					<input class="mediumfield" name="metainterval" type="text" value="<?php if ($_GET['action'] == "update") { echo $updateget_var_t_metainterval; } else { echo "32768"; }?>" />
