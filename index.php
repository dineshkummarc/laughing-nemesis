...
?>
    ...
    echo $messages["11"];
?></label>
							<input class="loginfield" name="captcha_field" type="text" pattern="[0-9]{5}" autocomplete="off" />
...
?>" />
    ...
    <footer>
        <p>
            Steamers Admin Panel | Dev by: djcrackhome & Dave | <a href="http://www.streamerspanel.com/" target="_blank">http://www.streamerspanel.com</a> | <a href="http://www.nagualmedia.de/" target="_blank">Design by Zephon</a> | <a href="http://www.facebook.com/streamers.admin.panel" target="_blank"><img src="./images/facebook.png" alt=""></a><a href="http://www.twitter.com/streamerspanel" target="_blank"><img src="./images/twitter.png" alt="" ></a>
        </p>
    </footer>
</div>
</body>
